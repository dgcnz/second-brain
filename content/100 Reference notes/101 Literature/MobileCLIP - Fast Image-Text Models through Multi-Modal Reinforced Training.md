...
**2024 · MobileCLIP - Fast Image-Text Models through Multi-Modal Reinforced Training**

Reinforce an image-text dataset offline with synthetic captions and teacher embeddings, then reuse that supervision to train compact image-text models.
