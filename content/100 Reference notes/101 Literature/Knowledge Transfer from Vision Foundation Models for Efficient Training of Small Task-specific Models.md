...
**2024 · Knowledge Transfer from Vision Foundation Models for Efficient Training of Small Task-specific Models**

Task-oriented transfer and data selection. Use limited task labels and retrieved transfer data to train small task-specific models efficiently from foundation models.
