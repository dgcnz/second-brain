...
export const AuthorInfo: QuartzComponentConstructor = () => {
  const Component: QuartzComponent = ({ fileData, displayClass, ctx }: QuartzComponentProps) => {
    const fm = fileData.frontmatter ?? {}
    const authorsRaw = (fm as Record<string, unknown>).authors
    const urlRaw = (fm as Record<string, unknown>).url
